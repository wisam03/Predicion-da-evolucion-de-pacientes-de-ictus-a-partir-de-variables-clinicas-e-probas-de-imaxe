...
# Para recalcularlos exactos: np.sum(atlas_nii.get_fdata() == label_id)
# *****************************************************************************
...
def update_excel(excel_path, results_by_codigo):
    """
    Función que actualiza de forma destructiva-controlada la base de datos en Excel utilizando openpyxl.
    ...
    # Construcción de una colección ordenada única con la unión de todas las llaves de características radiómicas extraídas
    all_keys, seen = [], set()
