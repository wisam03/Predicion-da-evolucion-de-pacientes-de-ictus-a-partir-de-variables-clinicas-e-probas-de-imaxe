...
| `Archivo_IS_MRI_actualizado.xlsx` | Base de datos clínica (variables clínicas + radiómicas) |
...
python extraccion_radiomicas.py \
    --excel /ruta/Archivo_IS_MRI_actualizado.xlsx \
...
| `R_A_VOL_TOAST_shape_volume_ml_intensity_range.ipynb` | Ingreso / 24h | NIHSS, VOL, radiómicas morfolóxicas |
